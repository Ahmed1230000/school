...
<div class="pt-8 pb-12 px-6 sm:px-8 lg:px-12">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <!-- Form -->
            <div class="px-8 py-8">
                <form id="assignPermissionForm" action="{{ route('assign-permission-to-user.store') }}" method="POST">
                    @csrf
                    <div class="space-y-8">
                        <!-- User Selection -->
                        <div>
                            <label for="user_id" class="block text-gray-700 font-medium mb-2 text-base">Select User</label>
                            <select id="user_id" name="user_id" required class="w-full border border-gray-300 rounded-lg p-3 text-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            <label class="block text-gray-700 font-medium mb-3 text-base">Select Permissions</label>
...
@section('scripts')
<script>
    document.getElementById('assignPermissionForm').addEventListener('submit', function(e) {
        ...
        if (permissions.length === 0) {
            ...
            errorMessage.innerHTML = `
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-base text-red-700">Please select at least one permission.</p>
                    </div>
                    <div class="ml-auto pl-4">
                        <button onclick="this.parentElement.parentElement.parentElement.style.display='none'" class="text-red-500 hover:text-red-700">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
