...
<div class="pt-8 pb-12 px-6 sm:px-8 lg:px-12">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <!-- Form -->
            <div class="px-8 py-8">
                <form id="createRoleForm" action="{{ route('roles.store') }}" method="POST" class="space-y-8">
                    @csrf
                    <!-- Role Name -->
                    <div>
                        <label for="name" class="block text-gray-700 font-medium mb-2 text-base">Role Name</label>
                    ...
                    <div class="mt-8 flex justify-end space-x-3">
                        ...
                        <a href="{{ route('roles.index') }}" class="inline-flex items-center px-5 py-2.5 border border-gray-300 shadow-sm text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        if (!roleName) {
            ...
            errorMessage.innerHTML = `
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-base text-red-700">Please enter a role name.</p>
                    </div>
                    <div class="ml-auto pl-4">
                        <button onclick="this.parentElement.parentElement.parentElement.style.display='none'" class="text-red-500 hover:text-red-700">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
